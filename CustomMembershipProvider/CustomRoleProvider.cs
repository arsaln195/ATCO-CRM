    ...
    public sealed class CustomRoleProvider : RoleProvider
    {
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            if (String.IsNullOrEmpty(config["description"]))
            {
                ...
                config.Add("description", "SMSPortal ROle Provider");
            }
        ...
        public override string[] GetAllRoles()
        {
            ...
            var systemRoles = db.sp_SystemRolesSelect(null);

            foreach (var systemRole in systemRoles)
            {
                tmpRoleNames += systemRole.RoleName + ",";
            }
        ...
        public override string[] GetRolesForUser(string username)
        {
            ...
            var userRoles = db.sp_EmploeesInRolesSelect01(username);

            foreach (var userRole in userRoles)
            {
                tmpRoleNames += userRole.RoleName + ",";
            }
        ...
        public override string[] GetUsersInRole(string rolename)
        {
            ...
            DatabaseDataContext db = new DatabaseDataContext(connectionString);
            var employees = db.sp_EmployeesSelectByRole(rolename);

            foreach (var employee in employees)
            {
                tmpUserNames += employee.LoginId + ",";
            }
        ...
        public override bool IsUserInRole(string username, string rolename)
        {
            ...
            //DatabaseDataContext db = new DatabaseDataContext(connectionString);
            //var smsSystemUserView = db.sp_SMSSystemUsersSelect01(username, null, null, "kkk");

            //foreach (var systemUserView in smsSystemUserView)
            //{
            //    userIsInRole = true;
            //}
